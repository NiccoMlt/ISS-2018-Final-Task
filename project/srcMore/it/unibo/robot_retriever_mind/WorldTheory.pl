%==============================================
% WorldTheory.pl for actor robot_retriever_mind
%==============================================
/*
For a QActor as a singleton statically degined in the model
*/
myname(qaturobot_retriever_mind).	%%old version (deprecated)
actorobj(qaturobot_retriever_mind).	%% see registerActorInProlog18 in QActor
...
%-------------------------------------------------
%  TuProlo FEATURES of the QActor robot_retriever_mind
%-------------------------------------------------
dialog( FileName ) :-  
...
%% :- stdout <- println(  "hello from world theory of robot_retriever_mind" ). 
