...
public class movePlanUtil {
    ...
    public static void move(final QActor qa, final String move, final String duration) {
        try {
    ...
    public static void moveNoMap(final QActor qa, final String move, final String duration) {
        try {
            String temporaryStr = "robotCmd(MOVE,T)".replace("MOVE", move).replace("T", duration);
    ...
    public static void startTimer(final QActor qa) {
        timeStart = System.currentTimeMillis();
    }

    public static void getDuration(final QActor qa) {
