  ...
  \begin{enumerate}
    ...
    \item
      ...
      \begin{itemize}
        ...
        \item when \requirementref{discovery} is at home, tells to \hypertarget{req:retriever}{another robot} (equipped with proper tools) to reach the discovered bag (\requirement{R-reachBag}) in order to put the bag in safe container and transport it to the initial position (\requirement{R-bagAtHome}).
      \end{itemize}
  \end{enumerate}
