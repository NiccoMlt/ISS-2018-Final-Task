...
Per svolgere i test si intende utilizzare il supporto fornito dal modulo \texttt{QActorUtils} della software house, che permette di ispezionare la base di conoscenza interna, ottenere i riferimenti e mandare messaggi ai QActors di un determinato contesto;
